...
-- ============================================
-- SELECT 'Players table created' AS status FROM Players LIMIT 0;
-- SELECT 'Games table created' AS status FROM Games LIMIT 0;
-- SELECT 'GamePlayers table created' AS status FROM GamePlayers LIMIT 0;
-- SELECT 'Ships table created' AS status FROM Ships LIMIT 0;
-- SELECT 'Moves table created' AS status FROM Moves LIMIT 0;
